%------------------------------------------------------
%         
%       Fonction d'elaboration du message UBX_CFG_GNSS
%       pour changer la configuration du récepteur (accepter ou refuser des
%       constellations)
%  
%------------------------------------------------------
...
%           - son identifiant
%           - le nombre de constellations à configurer
%           - 

function messageUBX = Creation_UBX_CFG_GNSS(classe,id,nomb_const)
